...
<section class="login-dark">
    <form method="post" action="?action=connect&controller=user">
        ...
        <a class="forgot" href="?action=signup&controller=user" style="margin-top: 20px;">Don't have an account ? Sign Up</a>
    </form>
</section>
